...
try:
    ...
    conn_str='database=bludb;hostname=9938aec0-8105-433e-8bf9-0fbb7e483086.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;\
...
def limitn():
    ...
    return render_template("limit1.html" , y= s)
...
def today():
      ...
      return render_template("today1.html", texpense = texpense, expense = expense,  total = total ,
